...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection project_tag_binds
     ...
     * @property Grid\Column|Collection mainstream
     ...
     * @method Grid\Column|Collection project_tag_binds(string $label = null)
     ...
     * @method Grid\Column|Collection mainstream(string $label = null)
     ...
     * @property Show\Field|Collection project_tag_binds
     ...
     * @property Show\Field|Collection mainstream
     ...
     * @method Show\Field|Collection project_tag_binds(string $label = null)
     ...
     * @method Show\Field|Collection mainstream(string $label = null)
